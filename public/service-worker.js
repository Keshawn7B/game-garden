const CACHE_NAME = "game-garden-shell-v5";
const APP_SHELL = ["/", "/manifest.webmanifest", "/app-icon-192.png", "/app-icon-512.png", "/game-garden-logo-red.png", "/theme-init.js?v=4", "/startup-loader.js?v=2", "/pwa-init.js?v=2"];
